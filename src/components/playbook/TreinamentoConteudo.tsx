/** Conteúdo reutilizável do Treinamento por Tiers — usado na página standalone e como tab do Playbook. */
...
const TIERS: Tier[] = [
  {
    ...
    topicos: [
      ...
      { titulo: 'Cadência de relacionamento', descricao: 'Contato semanal com os top 5 parceiros ativos. Reunião mensal de revisão de resultados. Reconheça publicamente parceiros que mais indicam (ranking no grupo de WhatsApp/Slack).' },
...
export default function TreinamentoConteudo() {
