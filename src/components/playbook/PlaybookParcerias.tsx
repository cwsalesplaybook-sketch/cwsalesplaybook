/** Playbook de Parcerias — estrutura pronta, conteúdo em construção. */
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 gap-4 text-center">
      ...
      <p className="text-sm text-cw-muted max-w-xs leading-relaxed">
        O conteúdo do <strong>Playbook de Parcerias</strong> ainda está sendo preparado pela liderança. Em breve estará disponível!
      </p>
    </div>
  );
}

export default function PlaybookParcerias() {
  return (
    <div className="p-8">
      <div className="mb-6">
        <h1 className="text-2xl font-black text-cw-text">Playbook de Parcerias</h1>
        <p className="text-sm text-cw-muted mt-1">Conteúdo exclusivo para o time de Parcerias da Cardápio Web.</p>
      </div>
