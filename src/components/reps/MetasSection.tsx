/** Metas — tracker pessoal de metas do mês (localStorage por representante).
 *  Mesmo componente/mecânica do Closer (useRepsMetas em vez de useCloserMetas). */
import { useState } from 'react';
import { Target, Calendar, TrendingUp, Plus, Trash2, Package, Settings2, Check } from 'lucide-react';
import { cn } from '@/lib/utils';
import { useRepsMetas, type MetaModulo } from '@/hooks/useRepsMetas';
...
export function MetasSection() {
  const { state, computed, update, setJaFechado, addModulo, updateModulo, removeModulo } = useRepsMetas();
