      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      isA ? 'border-cw-purple bg-cw-purple/5'
                        : isB ? 'border-[#59327A] bg-[#59327A]/5'
                  ...
                  >
                    ...
                    {/* Número principal — roxo escuro para legibilidade */}
                    <p className="text-xl font-black text-[#5b21b6]">{fmt(preco.total)}</p>
            ...
            <div className="space-y-1.5">
              {MODULOS.map(m => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className={cn('text-sm font-bold shrink-0', ativo ? 'text-[#5b21b6]' : 'text-cw-muted')}>
              ...
              <div className={cn(
                ...
                >
                  ...
                  <span className={cn('text-sm font-bold shrink-0', totem ? 'text-[#5b21b6]' : 'text-cw-muted')}>
                ...
                {totem && (
                  <div className="px-4 pb-3 flex items-center gap-3 border-t border-cw-purple/15 pt-2.5">
                    ...
                    <span className="text-sm font-bold text-[#5b21b6] w-20 text-right">
        ...
        <div className="space-y-4">
            ...
            {periodoA ? (
              <>
                ...
                <div className="mt-auto pt-4 border-t border-cw-border flex items-end justify-between">
                  ...
                  <span className="text-3xl font-black text-[#5b21b6]">{fmt(resultA!.total)}</span>
                </div>
              </>
            ) : (
              <p className="text-sm text-cw-muted mt-2">Selecione o período <span className="font-black text-[#5b21b6]">A</span> nos cards ao lado...</p>
            )}
          </div>
          ...
          {economia !== null ? (
            ...
            <button
              disabled
              className="w-full py-3.5 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-600/60 text-sm font-bold cursor-default"
            >
