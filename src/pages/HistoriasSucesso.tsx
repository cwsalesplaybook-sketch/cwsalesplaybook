...
const MEMBROS_PADRAO: MembroHall[] = [
  ...
  },
  {
    ...
    frase: '',
    historia: 'Natasha foi a primeira funcionária da Cardápio Web, entrando como estagiária de Marketing nos primeiros passos da empresa. Encontrou no design sua área de atuação, contribuindo com o rebranding e criando o Cardapinho, hoje parte da identidade da CW. Com o crescimento da empresa, assumiu a Supervisão de Marketing e depois a de Branding e Chapter de Design, consolidando a estratégia de marca. Agora inicia um novo capítulo como Coordenadora de Branding, ampliando o impacto de uma área que ajudou a construir desde o primeiro dia.',
    stats: [
