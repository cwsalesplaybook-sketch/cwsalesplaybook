...
const MEMBROS_PADRAO: MembroHall[] = [
  ...
  },
  {
    ...
    historia: 'Victor entrou na Cardápio Web em 2023 como Helpdesk no Suporte. Chegou a pedir desligamento por outras prioridades, mas a vontade de ficar era tanta que o Johnny topou ele trabalhar só à noite. Por 1 ano, conciliou outro emprego em horário comercial com a CW das 19h às 23h, sem folga. A aposta valeu: virou Supervisor de Atendimento, montou um time de 10 a 12 pessoas e, após dois processos seletivos, foi nomeado o primeiro Coordenador do pós-venda.',
    stats: [
