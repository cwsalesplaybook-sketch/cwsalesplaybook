...
const MEMBROS_PADRAO: MembroHall[] = [
  ...
  },
  {
    ...
    stats: [
      { icon: 'trending', valor: 'Cardapinho', label: 'CRIAÇÃO' },
      { icon: 'star',     valor: 'Coordenadora de Branding', label: 'CARGO ATUAL' },
      { icon: 'crown',    valor: 'Estagiária → Coordenadora', label: 'JORNADA' },
    ],
  },
  {
    ...
    historia: 'Victor entrou na Cardápio Web em 2023 como Helpdesk no time de Suporte. Chegou a pedir o próprio desligamento por outras prioridades que exigiam mais remuneração, mas a vontade de continuar era tanta que o Johnny topou ele ficar trabalhando só à noite. Por exatamente 1 ano, conciliou um emprego em horário comercial com a CW das 19h às 23h, sem folga entre os dois. A aposta valeu a pena: surgiu a chance de virar Supervisor de Atendimento, montou um time de 10 a 12 pessoas, várias delas crescendo tão rápido quanto ele, algumas sob sua liderança até hoje, como Karen Lethycia e Gabriel Barbosa. Depois de 1 ano no cargo e dois processos seletivos, foi nomeado o primeiro Coordenador do pós-venda da CW. Hoje seu foco é elevar a régua do Suporte inteiro e cuidar da reputação da empresa em atendimento, do Reclame Aqui às redes sociais.',
    stats: [
  ...
  },
  {
    ...
    jornada: ['Assistente', 'Consultor', 'Liderança de Implementação'],
    frase: '',
  ...
  {
    id: 'samuel', nome: 'Samuel Morais', foto: '/hall/SamuelMorais.png', cargo: 'Liderança de Implementação',
