/** Biblioteca de Estudos — clonada da aba do SDR (mesmo conteúdo inicial):
 *  livros, podcasts, vídeos, artigos e cursos recomendados. */
...
export default function RepsBiblioteca() {
