/** CW Store — clonado da aba do SDR (mesmo conteúdo inicial): o marketplace de
 *  apps parceiros da Cardápio Web, visão geral, funcionamento técnico e
 *  perspectiva comercial pro time vender. */
...
export default function RepsCwStore() {
  return (
    <>
